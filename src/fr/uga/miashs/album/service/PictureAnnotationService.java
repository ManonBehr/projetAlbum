	...
	public List<String> seeAnnotations(String uri){
        ...
        try (QueryExecution qexec = QueryExecutionFactory.sparqlService("http://localhost:3030/ALBUM/sparql", query)) {       
            ...
            for (; results.hasNext();) {
                ...
                System.out.println("seeAnnotationService entre x et r");
                Resource r = soln.getResource("p"); // une proppriete
                System.out.println("seeAnnotationService entre r et l");
                RDFNode l = soln.get("o"); // valeur de la propriete
                System.out.println(x + " " + r + " " + l);
//                if (x.toString().equals(uri)){
...
//                }
        ...
        // query doit obtenir toutes les propri�t�s et les valeurs de la propriete de l'uri pass�e en param�tres
        return annotations;
    }
